...
type MCPConfig struct {
	...
	OnDemand      bool              `json:"on_demand,omitempty" jsonschema:"description=Start this MCP server only for turns that explicitly request it,default=false"`
	Aliases       []string          `json:"aliases,omitempty" jsonschema:"description=Additional names that can activate this on-demand MCP server,example=google search console"`
